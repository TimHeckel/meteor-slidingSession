...
var processSessionTimeouts = function() {
	...
	console.log("REMOVING THE " + ActiveSessions.find({ heartbeat: false }).count() + " sessions");
	ActiveSessions.remove({ heartbeat: false });
};

var _checkSessionSettings;
Meteor.startup(function() {
 	_checkSessionSettings = Meteor.setInterval(function() {
